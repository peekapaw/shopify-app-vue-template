    ...
    <div class="main flex-1 mr-8">
      ...
      <v-card class="mt-4 pb-4" title="Customer Tag">
        <div class="px-4">
          <v-text-field
            label=""
            placeholder="e.g. VIP, Gold, Silver, bronze"
            variant="outlined"
            density="compact"
            hint="Customer tag is case-insensitive"
...
const save = () => {
  discountStore.createDiscountGroup(form.value)
}
</script>
